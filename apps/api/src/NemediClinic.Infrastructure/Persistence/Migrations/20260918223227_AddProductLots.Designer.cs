...
namespace NemediClinic.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260918223227_AddProductLots")]
    partial class AddProductLots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NemediClinic.Domain.Entities.Product", b =>
                {
                    ...
                    b.Property<string>("RegistroSanitarioInvima")
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)");
                    ...
                    b.Property<string>("TipoRegulatorio")
                        .IsRequired()
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("NemediClinic.Domain.Entities.ProductLot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProductId", "FechaVencimiento");
            ...
            modelBuilder.Entity("NemediClinic.Domain.Entities.InventoryEntry", b =>
                {
                    ...
                    b.HasOne("NemediClinic.Domain.Entities.ProductLot", "ProductLot")
                        .WithMany()
