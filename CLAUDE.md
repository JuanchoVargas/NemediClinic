...
- Dashboard: real numbers from `hooks/use-dashboard.ts`, built on existing endpoints (appointments of the week, patient `totalCount`, stock alerts) because `GET /api/v1/dashboard` does not exist yet; an Esteticista sees her own agenda.
